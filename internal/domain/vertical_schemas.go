...
var VerticalSchemas = map[Vertical]VerticalSchema{
	VerticalVeterinary: {
		...
		Fields: []FieldDef{
			...
			{Key: "allergies", Label: "Allergies", Type: FieldTypeLongText, PHI: true,
				HelpText: "Substance-triggered reactions (e.g. penicillin, bee stings). Use only for confirmed hypersensitivities — not general intolerances."},
			{Key: "chronic_conditions", Label: "Chronic conditions", Type: FieldTypeLongText, PHI: true,
				HelpText: "Long-term diagnoses managed over time (e.g. diabetes, arthritis, kidney disease). Acute or one-off issues belong in the visit note."},
	...
	VerticalDental: {
		...
		Fields: []FieldDef{
			...
			{Key: "allergies", Label: "Allergies", Type: FieldTypeLongText, PHI: true,
				HelpText: "Substance-triggered reactions (e.g. penicillin, latex). Use only for confirmed hypersensitivities — not general intolerances."},
			{Key: "chronic_conditions", Label: "Chronic conditions", Type: FieldTypeLongText, PHI: true,
				HelpText: "Long-term diagnoses managed over time (e.g. diabetes, hypertension). Acute or visit-specific issues belong in the note."},
			{Key: "admission_warnings", Label: "Admission warnings", Type: FieldTypeLongText},
			{Key: "insurance_provider_name", Label: "Insurance provider", Type: FieldTypeText},
			{Key: "insurance_policy_number", Label: "Policy number", Type: FieldTypeText, PII: true},
	...
	VerticalGeneralClinic: {
		...
		Fields: []FieldDef{
			...
			{Key: "medications", Label: "Current medications", Type: FieldTypeLongText, PHI: true},
			{Key: "allergies", Label: "Allergies", Type: FieldTypeLongText, PHI: true,
				HelpText: "Substance-triggered reactions (e.g. penicillin, peanuts). Use only for confirmed hypersensitivities — not general intolerances."},
			{Key: "chronic_conditions", Label: "Chronic conditions", Type: FieldTypeLongText, PHI: true,
				HelpText: "Long-term diagnoses managed over time (e.g. diabetes, hypertension). Acute or visit-specific issues belong in the note."},
			{Key: "admission_warnings", Label: "Admission warnings", Type: FieldTypeLongText},
			{Key: "insurance_provider_name", Label: "Insurance provider", Type: FieldTypeText},
	...
	VerticalAgedCare: {
		...
		// Aged care contacts are typically the EPOA / substitute decision
		// maker, not just kin — surface both so clinicians don't have to
		// pick the wrong one for the legal context.
		ContactLabel:       "EPOA / Next of kin",
		Fields: []FieldDef{
			{Key: "date_of_birth", Label: "Date of birth", Type: FieldTypeDate, Required: true},
			{Key: "sex", Label: "Sex", Type: FieldTypeEnum,
				Options: []string{"male", "female", "other", "unknown"}},
			...
			{Key: "medications", Label: "Current medications", Type: FieldTypeLongText, PHI: true},
			{Key: "allergies", Label: "Allergies", Type: FieldTypeLongText, PHI: true,
				HelpText: "Substance-triggered reactions (e.g. penicillin, shellfish). Use only for confirmed hypersensitivities — not general intolerances."},
			{Key: "chronic_conditions", Label: "Chronic conditions", Type: FieldTypeLongText, PHI: true,
				HelpText: "Long-term diagnoses managed over time (e.g. dementia, COPD, CHF). Acute issues or new symptoms belong in the daily note."},

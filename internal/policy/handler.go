...
type clauseInputItem struct {
	...
	SourceCitation *string `json:"source_citation,omitempty"               doc:"Optional verbatim quote from a regulator document. Stored as-is; AI-generated citations are rendered with a 'verify' badge in the editor."`
}
